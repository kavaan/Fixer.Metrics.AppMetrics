...
using Fixer.Metrics.AppMetrics.Builders;
using Microsoft.AspNetCore.Hosting;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;

namespace Fixer.Metrics.AppMetrics
{
    public static class Extensions
    {
        ...
        public static IFixerBuilder AddMetrics(this IFixerBuilder builder, string sectionName = SectionName)
        {
        ...
        public static IFixerBuilder AddMetrics(this IFixerBuilder builder, MetricsOptions options)
        {
